...
const Level = ({
  ...
  return (
    <>
      ...
      <div className={`border-b border-black/20 mt-3 bg-white ${addedQuestionCls}`}>
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-lg ff_outfit text-black capitalize">Level :{level}</h2>
          {deletePopup === true ? (
        ...
        <p className="font-normal ff_outfit text-base text-black capitalize">{description}</p>
