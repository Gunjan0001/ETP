...
const User = () => {
  ...
  const { studentsData, updateStudentData, updateStatusonFirebase } = StudentgetterContext();
              ...
              <div className="flex items-center rounded-[10px] py-3 text-[#FF0000] bg-[#EFEFEF]">
                <div className="relative z-[999]">
                  ...
                  {isOpenall && (
                    <div
                      ref={dropdownRef}
                      className="absolute z-50 right-0 mt-2 w-[180px] origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div
                        className="py-1"
                        role="menu"
                          ...
                          <div className="relative z-[9999]">
                            <Menu>
                              ...
                              <Menu.Items
                                ...
                                {value.status === LeadStatus.NOT_INTERESTED ||
                                value.status === LeadStatus.NEW ||
                                value.status === undefined ? (
                                  <Menu.Item>
                                    <Link
                                      onClick={() =>
                                        handleUpdateStatus(value.id, LeadStatus.SUCCEED)
                                      }
                                      className="flex items-center py-3 px-5 gap-4 cursor-pointer">
                                      <SuccedIcon />
                                      <p className="ff_inter font-normal text-base mb-0 ">
                                ...
                                {value.status === LeadStatus.NEW || value.status === undefined ? (
                                  <Menu.Item>
                                    <Link
                                      onClick={() =>
                                        handleUpdateStatus(value.id, LeadStatus.NOT_INTERESTED)
                                      }
                                      className="flex items-center py-3 px-5 gap-4 cursor-pointer">
                                      <NotInterestedIcon />
                                      <p className="ff_inter font-normal text-base mb-0 ">
